# Form implementation generated from reading ui file 'D:\FinalProject\FinalProject\ui\Admin.ui'
#
...
"}")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("/images/icons/RedIcons/home_ic.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("/images/icons/RedIcons/Revenue_ic.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("/images/icons/RedIcons/setting_ic.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("/images/icons/RedIcons/menu_ic.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.label_2.setPixmap(QtGui.QPixmap("/images/icons/RedIcons/search_ic.svg"))
...
"font: 12pt \"Sans Serif Collection\";")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("/images/icons/RedIcons/user_ic.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.label_3.setPixmap(QtGui.QPixmap("/images/icons/RedIcons/dollar_sign_ic.svg"))
        ...
        self.label_7.setPixmap(QtGui.QPixmap("/images/icons/RedIcons/shopping_cart_ic.svg"))
        ...
        self.label_10.setPixmap(QtGui.QPixmap("/images/icons/RedIcons/film_ic.svg"))
        ...
        self.label_13.setPixmap(QtGui.QPixmap("/images/icons/RedIcons/users_ic.svg"))
...
"font: 75 bold 10pt \"MS Shell Dlg 2\";")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("/images/icons/WhiteIcons/delete_ic.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("/images/icons/WhiteIcons/edit_ic.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("/images/icons/WhiteIcons/create_ic.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.label_16.setPixmap(QtGui.QPixmap("/images/Admin/UEL_Logo.png"))
        ...
        self.label_22.setPixmap(QtGui.QPixmap("/images/Admin/FIS_Logo.png"))
        ...
        self.label_18.setPixmap(QtGui.QPixmap("/images/avatar.jpg"))
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("/images/icons/RedIcons/log_out.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
