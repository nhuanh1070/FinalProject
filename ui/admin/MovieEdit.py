# Form implementation generated from reading ui file 'D:\FinalProject\FinalProject\ui\admin\MovieEdit.ui'
#
...
"    color: rgb(86, 0, 8);")
        ...
        self.verticalLayout_4.addWidget(self.lineEditGenre, 0, QtCore.Qt.AlignmentFlag.AlignBottom)
        ...
        self.widget = QtWidgets.QWidget(parent=self.widget_7)
        ...
        self.textEditDescription.setStyleSheet("font: 12pt \"Microsoft YaHei UI\";")
        self.textEditDescription.setObjectName("textEditDescription")
        self.verticalLayout_12.addWidget(self.textEditDescription)
        self.horizontalLayout_3.addWidget(self.frame_4, 0, QtCore.Qt.AlignmentFlag.AlignLeft)
        ...
        self.verticalLayout_13.addWidget(self.labelImage, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        self.horizontalLayout_3.addWidget(self.frame_7, 0, QtCore.Qt.AlignmentFlag.AlignRight)
        ...
        self.verticalLayout_11.addWidget(self.frame_9, 0, QtCore.Qt.AlignmentFlag.AlignBottom)
        self.horizontalLayout_3.addWidget(self.widget_8, 0, QtCore.Qt.AlignmentFlag.AlignRight)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_AddPoster.setText(_translate("Dialog", "icon thêm"))
