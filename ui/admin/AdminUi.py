...
"font: 75 bold 11pt \"MS Shell Dlg 2\";")
        ...
        self.btnExportFile = QtWidgets.QPushButton(parent=self.widget_8)
        self.btnExportFile.setMaximumSize(QtCore.QSize(36, 36))
        self.btnExportFile.setLayoutDirection(QtCore.Qt.LayoutDirection.RightToLeft)
        self.btnExportFile.setAutoFillBackground(False)
        self.btnExportFile.setStyleSheet("")
        self.btnExportFile.setText("")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/RedIcons/images/icons/RedIcons/log_out.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btnExportFile.setIcon(icon7)
        self.btnExportFile.setIconSize(QtCore.QSize(24, 24))
        self.btnExportFile.setAutoDefault(True)
        self.btnExportFile.setObjectName("btnExportFile")
        self.horizontalLayout_5.addWidget(self.btnExportFile)
        self.btnStatistic = QtWidgets.QPushButton(parent=self.widget_8)
        self.btnStatistic.setMaximumSize(QtCore.QSize(36, 36))
        self.btnStatistic.setLayoutDirection(QtCore.Qt.LayoutDirection.RightToLeft)
        self.btnStatistic.setAutoFillBackground(False)
        self.btnStatistic.setStyleSheet("")
        self.btnStatistic.setText("")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/RedIcons/images/icons/RedIcons/Revenue_ic.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btnStatistic.setIcon(icon8)
        self.btnStatistic.setIconSize(QtCore.QSize(24, 24))
        self.btnStatistic.setAutoDefault(True)
        self.btnStatistic.setObjectName("btnStatistic")
        self.horizontalLayout_5.addWidget(self.btnStatistic)
...
"color: rgb(253, 253, 250);")
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/Menu/images/icons_menu/revenue_ic.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.tabWidget.addTab(self.tab_Revenue, icon9, "")
